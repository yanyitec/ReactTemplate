...
(function (global, factory) {
            ...
            function checkType(isRequired, props, propName, componentName, location, propFullName, secret) {
                ...
                if (secret !== ReactPropTypesSecret_1) {
                    if (throwOnDirectAccess) {
                        ...
                        invariant_1(false, 'Calling PropTypes validators directly is not supported by the `prop-types` package. ' +
                        ...
                        if (!manualPropTypeCallCache[cacheKey] &&
                            ...
                            warning_1(false, 'You are manually calling a React.PropTypes validation ' +
        ...
        function createUnionTypeChecker(arrayOfTypeCheckers) {
            ...
            for (var i = 0; i < arrayOfTypeCheckers.length; i++) {
                ...
                if (typeof checker !== 'function') {
                    warning_1(false, 'Invalid argument supplied to oneOfType. Expected an array of check functions, but ' +
    ...
    */
    ...
    function finalPropsSelectorFactory(dispatch, _ref2) {
        var initMapStateToProps = _ref2.initMapStateToProps, initMapDispatchToProps = _ref2.initMapDispatchToProps, initMergeProps = _ref2.initMergeProps, options = objectWithoutProperties(_ref2, ['initMapStateToProps', 'initMapDispatchToProps', 'initMergeProps']);
